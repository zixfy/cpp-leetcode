...
//
//
//  遵循上述移动规则将导致一组重复下标序列 seq[0] -> seq[1] -> ... -> seq[k - 1]
//  -> seq[0] -> ... 所有 nums[seq[j]] 应当不是 全正 就是 全负 k > 1
//
//
...
// 输入：nums = [-2,1,-1,-2,-2]
// 输出：false
// 解释：按下标 1 -> 2 -> 1 -> ... 的运动无法构成循环，因为 nums[1] 是正数，而
// nums[2] 是负数。 所有 nums[seq[j]] 应当不是全正就是全负。
//
//
//
//  提示：
...
//
//  Related Topics 数组 哈希表 双指针 👍 205 👎 0
